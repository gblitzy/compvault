...
- [ ] Call the EPIC-04 character-search + autocomplete endpoint (`mode=autocomplete`) and map each `suggestions[]` entry (`character_id`, `name`, `alias_matched`) to a rendered suggestion (@frontend-engineer)
