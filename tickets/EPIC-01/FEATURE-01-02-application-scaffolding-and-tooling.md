...
- [ ] The scaffold is configured to target the Next.js App Router on Vercel, building on the single Blitzy environment from [FEATURE-01-01 — Blitzy Environment Provisioning](FEATURE-01-01-blitzy-environment-provisioning.md) per <https://docs.blitzy.com/administration/environments>.
